...
.nav2 {
	background-color: rgb(255 140 7 / 88%);
	width: 100%;
	display: flex;
	align-items: center;
...
<nav>
	<div class="home-nav">
		<div class="logo">
			<img class="logo" src="images/logo.jpg" alt="profImage"
				height="40px">
		...
		<div class="nav-links">
			<div class="userprof">
				<a href="" class="usernameBTN"> <img class="proficon"
					src="images/account.png" alt="profImage" width="30px"
					height="30px">
					<h5 class="uname">Account</h5></a>
			</div>
			<div class="logout-btn">
				<a href="login.jsp" class="logoutBTN">
					<h5 class="logout">Log-in</h5>
				</a>
			</div>
...
<body style="background-color: whitesmoke;">
	<img src="images/1.jpg" alt="Banner image" class="banner image"
	...
	<div class="container" id="products">
		<div class="row">
			<c:forEach var="product" items="${allproducts}">
				<div class="cardsSet">
			    <div class="card">
			        <img src="${pageContext.request.contextPath}/images/${product.itemImage}" alt="Uploaded Image" style="width: 288.4px;" />
			        <div class="card-body">
			            <h5 class="card-title" style="color: black;">${product.itemName}</h5>
	...
	<section class="endform" id="formbox">
		<div class="container">
			<div class="split">
				<div class="logoCont">
					<img class="footerLogo" src="images/logo.jpg" width="200px"
						alt="Logo">
					<h2>Everything on your fingertips.....</h2>
					<p>just shop! we Deliver...</p>
				</div>

				<div class="list">
					<h4 class="footerTitle">Main Menu</h4>
					<ul>
						<li><a class="a1" href="#">News</a></li>
						<br>
						<li><a class="a1" href="#">Feedback</a></li>
						<br>
						<li><a class="a1" href="#">Updates</a>
						</li>
						<br>
						<li><a class="a1" href="#">social media</a></li>
						<br>
