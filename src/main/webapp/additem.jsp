...
<div class="container" style="width:700px; margin-top:80px;">
    ...
    <form class="add-items-form" action="insertServlet" method="post" id="items_form" enctype="multipart/form-data">
        <fieldset>
            <!-- Form Name -->
			...
			<script>
			    ...
			    form.addEventListener("submit", function (event) {
			        ...
			        if (quantityInput.value.trim() === "") {
			            isValid = false;
			            document.getElementById("quantityError").textContent = "Quantit is required";
			    ...
			    <input type="text" name="quantity" class="form-control" id="price" placeholder="quantity">
			    <span id="priceError" class="text-danger"></span>
			</div>
